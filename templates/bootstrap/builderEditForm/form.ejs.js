...
'\n    </div>\n    ';
 if (!ctx.preview) { ;
__p += '\n    <div style="margin-top: 10px;">\n      <button class="btn btn-success" style="margin-right: 10px;font-size:20px;  " ref="saveButton">' +
((__t = (ctx.t('Inserisci'))) == null ? '' : __t) +
'</button>\n      <button class="btn btn-secondary" style="margin-right: 10px;font-size:20px;" ref="cancelButton">' +
((__t = (ctx.t('Cancella'))) == null ? '' : __t) +
'</button>\n' +
' </div>\n    ';
 } ;
__p += '\n  </div>\n  ';
